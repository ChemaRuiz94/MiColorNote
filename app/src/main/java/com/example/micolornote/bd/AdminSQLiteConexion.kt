...
class AdminSQLiteConexion(
    ...
    override fun onCreate(db: SQLiteDatabase) {
        ...
        db.execSQL("create table ${Constantes.TAB_TAREAS} (${Constantes.ID_TAREA} text primary key, ${Constantes.ID_TAREA_CRUCE} text, ${Constantes.TEXTO_TAREA} text, ${Constantes.TAREA_REALIZADA} boolean, ${Constantes.FOTO_TAREA} int)")
